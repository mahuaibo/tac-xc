...
contract XCPlugin is XCPluginInterface {
    ...
    function init() internal {
        ...
        admin.tokenSymbol = "TAB";
        admin.account = msg.sender;
        admin.version = "1";
        platform.status = true;
        platform.name = "TAC";
        platform.weight = 2;
        platform.publicKeys.push(0x7f9f670e3D42Db6Fe9927a2f9Fb8e7A1AA9fC7f0);
        platform.publicKeys.push(0xB4e2dE8c0785d1fc18100298c8e622e8b88eb591);
    }
